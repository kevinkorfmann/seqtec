...
\begin{sourcebox}
Workflow-engine concepts are anchored by the Nextflow and Snakemake reports \cite{diTommaso2017,molder2021}. The examples are educational starting points, not production-ready merely because they parse; Version~2 requires executable fixtures, pinned environments, and expected-output checks.
\end{sourcebox}
