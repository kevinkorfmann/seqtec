...
\begin{sourcebox}
The differential-expression and transcript-quantification sections are anchored by the DESeq2 and Salmon method papers \cite{love2014,patro2017}. Method assumptions, design matrices, transcript annotations, and software versions must be reported for a reproducible analysis.
\end{sourcebox}
