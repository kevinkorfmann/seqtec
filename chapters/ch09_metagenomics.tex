...
\begin{sourcebox}
Amplicon sequence-variant inference and genome-resolved quality terminology are anchored by primary method and standards papers \cite{callahan2016}. Database completeness, taxonomic labels, and classifier performance change over time and depend strongly on the sampled biome.
\end{sourcebox}
...
\footnotesize
\begin{tabularx}{\textwidth}{@{}p{1.7cm} p{1.8cm} p{1.8cm} p{2.6cm} p{1.7cm} X@{}}
\toprule
