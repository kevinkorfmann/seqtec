...
An SNV is a change of a single nucleotide at a specific genomic position. When an SNV is present in $\geq$1\% of a population, it is conventionally called a \textbf{single nucleotide polymorphism (SNP)}. SNVs are the most abundant variant class: a typical human genome contains $\sim$4.1--4.5 million SNVs compared to the GRCh38 reference.
