...
Short-read sequencing---the generation of millions to billions of relatively short DNA sequence reads, typically 50--600 bases in length---remains the workhorse of modern genomics. Since the commercialisation of the first massively parallel sequencing instruments in the mid-2000s, short-read platforms have driven an extraordinary collapse in the cost of DNA sequencing, from roughly \$100 million per human genome (Sanger-era) to well under \$200 today. This chapter provides a comprehensive survey of the platforms available, beginning with the dominant Illumina ecosystem and extending to the growing number of competitors that have entered the market.
...
\begin{itemize}[nosep]
  ...
  \item \textbf{Output:} 1.3~Tb (10B flow cell) to 16~Tb (25B flow cell, NovaSeq~X~Plus with two flow cells running simultaneously).
  ...
  \item \textbf{Cost:} approximately \$2--4 per Gb; roughly \$200 for a 30$\times$ human genome.
...
NovaSeq X (10B)   & Illumina   & $2\times150$\basepair & 1.3~Tb  & \$2--4      & 13--24\,h  \\
NovaSeq X Plus (25B) & Illumina & $2\times150$\basepair & 16~Tb  & \$2--3      & 24--48\,h  \\
\addlinespace
