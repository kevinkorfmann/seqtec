...
\begin{sourcebox}
Transposase-based library construction is anchored by its primary demonstration \cite{adey2010}. Exact volumes, incubation times, adapter structures, and compatibility statements remain kit- and revision-specific and must be verified against the protocol shipped for the reagent lot in use.
\end{sourcebox}
