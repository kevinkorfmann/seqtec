...
\begin{sourcebox}
CUT\&RUN is anchored by its primary method report \cite{skene2017}. Comparisons with ChIP-seq and CUT\&Tag depend on antibody performance, input, target abundance, controls, and the precise protocol, so categorical superiority claims require matched benchmarks.
\end{sourcebox}
