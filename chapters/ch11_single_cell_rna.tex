...
\begin{sourcebox}
The analysis-framework discussion is anchored by the Scanpy and multimodal Seurat method papers \cite{wolf2018,hao2021}. Cell recovery, multiplet rate, barcode lists, and reads-per-cell recommendations are chemistry-specific and must be read from the matching 10x protocol revision.
\end{sourcebox}
