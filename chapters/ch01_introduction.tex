...
\begin{sourcebox}
The historical account is anchored by the original Sanger sequencing paper and the public human-genome sequence reports \cite{sanger1977,venter2001}. Cost and current-platform claims are time-sensitive and must also be checked against the dated official sources identified in the Version~2 verification ledger.
\end{sourcebox}
