...
\begin{sourcebox}
Genome-wide Hi-C and the original compartment analysis are anchored by the primary Hi-C report \cite{lieberman2009}. Nominal matrix bin size is not the same as statistically supported biological resolution; depth requirements depend on genome size, contact range, filtering, and the feature being tested.
\end{sourcebox}
...
\label{subsec:3dgenome:compartment-analysis}
