...
\begin{sourcebox}
Assembly, taxonomic classification, and long-read small-variant calling are anchored by the Flye, Kraken~2, and Clair3 papers \cite{kolmogorov2019,wood2019,zheng2022}. Version~2 additionally requires commands to run on identified public fixtures; paper-level method accuracy is not a guarantee for every sample.
\end{sourcebox}
