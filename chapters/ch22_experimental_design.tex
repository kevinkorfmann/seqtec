...
\begin{table}[htbp]
\centering
\caption{Recommended sequencing depth by application.}
\label{tab:seq-depth}
\small
\renewcommand{\arraystretch}{1.3}
...
For example, a NovaSeq X 10B flow cell producing 10 billion reads can accommodate approximately 330 WGS samples at 30$\times$ coverage ($\sim$30M read pairs each with PE150 for a 3~Gb genome), or 333 RNA-seq samples at 30M reads each.
