...
% \addbibresource{references.bib}  % Uncomment when bibliography file is created
...
\input{chapters/ch02_molecular_biology}
\input{chapters/ch03_sequencing_principles}

% Part II: Platforms and Technologies
\part{Sequencing Platforms and Technologies}
\input{chapters/ch04_short_read_platforms}
\input{chapters/ch05_long_read_platforms}
\input{chapters/ch06_library_preparation}

% Part III: DNA Sequencing Applications
\part{Genomics: Reading the Blueprint}
\input{chapters/ch07_genome_sequencing}
\input{chapters/ch08_variant_discovery}
\input{chapters/ch09_metagenomics}

% Part IV: Transcriptomics
\part{Transcriptomics: Gene Expression and RNA Biology}
\input{chapters/ch10_rna_sequencing}
\input{chapters/ch11_single_cell_rna}
\input{chapters/ch12_spatial_transcriptomics}

% Part V: Epigenomics and Chromatin
\part{Epigenomics: Beyond the Sequence}
\input{chapters/ch13_dna_methylation}
\input{chapters/ch14_chromatin_accessibility}
\input{chapters/ch15_histone_modifications}
\input{chapters/ch16_3d_genome}

% Part VI: Multiomics, Specialized, and Emerging
\part{Multiomics and Emerging Frontiers}
\input{chapters/ch17_single_cell_multiomics}
\input{chapters/ch18_specialized_applications}
\input{chapters/ch19_emerging_technologies}

% Part VII: Bioinformatics and Data Analysis
\part{Bioinformatics and Data Analysis}
\input{chapters/ch20_bioinformatics_fundamentals}
\input{chapters/ch21_analysis_workflows}
\input{chapters/ch22_experimental_design}
\input{chapters/ch23_data_standards}

% Part VIII: Democratisation of Sequencing
\part{Democratisation of Sequencing}
\input{chapters/ch24_accessible_sequencing}
\input{chapters/ch25_practical_protocols}
\input{chapters/ch26_diy_analysis}
...
% \printbibliography[heading=bibintoc,title={References}]  % Uncomment with .bib file
